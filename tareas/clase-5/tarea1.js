...
function calcularSalarioMensual(salarioAnual){
  ...
  $calcularSalarioMensual.onclick = function(){
    ...
    return false; // para que no cargue el formulario
                  // tambien puedo ponerle al button type="button" en el html 
  }
